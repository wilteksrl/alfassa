...
<View style={{marginTop:16}}>
  <ListItem onPress={onPress} bottomDivider={bottomDivider} containerStyle={{elevation:1,padding:5,paddingBottom:15,paddingLeft:16,paddingRight:16,paddingTop:15,backgroundColor:"white",borderRadius:4,overflow:"hidden"}}>
<Icon name={icon}/>
